...
import BgShoes3 from "../assets/image/BgShoes3.jpg"
import Footer from "../Footer"


// Using Slice for Display Less Products
    const recentProduct = products.slice(115,131)
...
const HeroSection = () => (
  <div className="relative w-full h-[520px] md:h-[600px] overflow-hidden mb-40">
    ...
    <>
        ...
        <section className="grid grid-cols-2 xs:grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-4 mb-16">
                    {recentProduct.map((product, index) => (
                        ...
                        <div key={index} className="relative w-full bg-gray50 shadowmd hover:shadowxl transition-shadow duration-300 ease-in-out rounded-md overflow-hidden">
                            ...
                            <NavLink to={`/product/${product.id}`}>
                                <div className="relative md:w-[300px]  w-full aspect-square md:aspect-auto h-56 md:h-[350px] ">
                                    <img 
                                        src={`/${product.image}`} 
                                        alt={product.name} 
