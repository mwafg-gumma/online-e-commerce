...
import Bgw7 from "../assets/image/Bgw7.jpg"
import Footer from "../Footer"


// Using Slice for Display Less Products
    const recentProduct = products.slice(32, 52)
...
const Women = () => {
    ...
    // Hero Section
        ...
        const HeroSection = () => (
        <div className="relative w-full h-[600px] bg-gray-900 overflow-hidden mb-12">
            <img 
                src={Bgw7} 
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center p-4">
                ...
                <p className="mt-4 text-xl md:text-2xl text-gray-200 font-medium max-w-xl">
                    Discover our newest collection of essential Womenswear, designed for style and comfort.
                </p>
